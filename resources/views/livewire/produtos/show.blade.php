        ...
        <div class="overflow-auto h-52 mt-4">
            ...
            <table wire:loading.class="hidden"
                ...
                <tr class="rounded-lg text-sm font-medium text-gray-700 text-left table-row"
                    ...
                    <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Preço de Custo
                    </th>
                    
                    <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">Lucro
                    </th>

                    <th class="px-4 py-2 bg-gray-200 " style="background-color:#f8f8f8">V. Total
                    </th>
                ...
                @foreach($produtos as $key => $row)
                    ...
                    <tr class="hover:bg-gray-100 border-b border-gray-200 py-2 ">
                        ...
                        <td class="px-4 py-1">{{$row->lucro }} %</td>
